...
export class MediatorMock extends Contract {
  functions: {
    ...
    skipToNextQuarter(): Promise<ContractTransaction>;

    closeDispute(clientAddress: string): Promise<ContractTransaction>;

    setOpenBalanceDisputeCounter(
      counter: number | string
    ...
    halt(): Promise<ContractTransaction>;
    ...
    destroyDispute(clientAddress: string): Promise<ContractTransaction>;
    ...
    skipBlocks(n: number | string): Promise<ContractTransaction>;
    ...
    setDisputeSummaryCounter(
      clientAddress: string,
      newcounterValue: number | string
    ): Promise<ContractTransaction>;

    setPreviousOpeningBalanceClient(
      clientAddress: string,
      newOpeningBalance: number | string,
      pos: number | string
    ): Promise<ContractTransaction>;
    ...
    skipToNextRound(): Promise<ContractTransaction>;
  ...
  filters: {
    ShowAddress(value: null): EventFilter;

    ShowUint256(value: null): EventFilter;
